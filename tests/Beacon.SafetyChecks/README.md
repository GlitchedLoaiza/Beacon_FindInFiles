...
The [2.2.0 promotion record](../../docs/releases/2.2.0/PROMOTION.md) tracks the authorized **Beta → Release** reconciliation, shipping source, fresh validation and exact package hashes. The earlier [Beta candidate preparation](../../docs/releases/2.2.0/PREPARATION.md) remains historical evidence and must not be confused with the final upload. GitHub Release asset publication is a separate maintainer action.

The latest implementation and feedback work covers automatic multicore searching, ordered result limits, completed progress, Previous/Next text navigation, session-only Summary, readable Beacon highlights, the text match counter, marker-free Help tour replay, and clearing every preview's navigation on Reset. The pre-version-bump follow-up passed **93 checks in both Debug and Release**; the promotion record contains fresh clean-Release validation and exact package evidence. Earlier counts and artifact hashes below remain historical.
...
The historical [2.1.0 preparation record](../../docs/releases/2.1.0/PREPARATION.md) preserves the pre-theme candidate, [source promotion validation](../../docs/releases/2.1.0/PREPARATION.md#source-promotion-validation), and the later theme-enabled package under [packages/7dbb342](../../docs/releases/2.1.0/packages/7dbb342/release-manifest.json). Their original hashes, notices, build results, and validation counts remain intact. None of those older records validate the 2.2.0 shipping package.
