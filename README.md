...
Use the checksum for the **same file and version** you downloaded. The [2.1.0 checksum list](docs/releases/2.1.0/packages/7dbb342/SHA256SUMS.txt) includes separate values for the ZIP and EXE.

<details>
<summary>Show the prepared 2.1.0 hashes and PowerShell verification steps</summary>

These values identify the exact prepared package. The [artifact manifest](docs/releases/2.1.0/packages/7dbb342/release-manifest.json) contains the full build details.

**Source update:** this package includes Beacon Theme. Use the hashes below for this exact download.

<!-- RELEASE-HASHES: copied from the verified 2.1.0 package; regenerate after rebuilding or repackaging. -->
Prepared locally on **2026-09-16 UTC** from `master` at `7dbb342` (Release, win-x64, self-contained single-file, ReadyToRun off):
